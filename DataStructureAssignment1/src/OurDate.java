...
public class OurDate {
	...
	public boolean isGreater (OurDate date) {
		return (date.getYear()<this.getYear()) || 
				//if year is greater
				((date.getYear()==this.getYear()) && (date.getMonth()<this.getMonth())) || 
				//if year is the same, month greater(
				((date.getYear()==this.getYear()) && (date.getMonth()==this.getMonth()) && (date.getDay()<this.getDay()));
				//if year and month are the same, day greater
	}
